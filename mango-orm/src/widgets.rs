...
pub enum FieldType {
    ...
    InputRadioF64(f64),
    InputColor(String),
    InputDate(String),     // Example: "1900-01-01"
    InputDateTime(String), // Example: "1900-01-01T00:00:00"
    InputEmail(String),
    InputFile,
    InputImage,
    InputNumberI32(i32),
