...
- **v0.6.0** _The **created_at** and **updated_at** fields are automatically added to the Model. The widget type is **inputDateTime** and **is_hide = true, readonly = true**. Updated **README.md**. Updated documentation._
