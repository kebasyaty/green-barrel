...
- **v0.6.0** _The **created_at** and **updated_at** fields are automatically added to the Model. The widget type is **hiddenText** and **disabled = true**. Updated **README.md**. Updated documentation._
