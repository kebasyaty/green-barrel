...
impl Default for Color {
    fn default() -> Self {
        Self {
            ...
            err_msg: String::from("Invalid Color code."),
            minlength: 0,
            maxlength: 256,
            required: false,
            unique: false,
            ...
            hint: String::from(
                "Examples: #fff|#f2f2f2|#ffffff00|rgb(255,0,24)|rgba(255,0,24,0.5)|rgba(#fff,0.5)|hsl(120,100%,50%)|hsla(170,23%,25%,0.2)|0x00ffff",
            ),
            warning: String::new(),
            errors: Vec::new(),
            group: 1,
