...
pub struct ChoiceU32MultField {
    ...
    pub choices: Vec<(u32, String)>, // Html tag: <option value="value">Title</option> ; Example: vec![(5, "Title"), (25, "Title 2")].
...
impl Default for ChoiceU32MultField {
    fn default() -> Self {
        Self {
            id: String::new(),
            label: String::new(),
            field_type: String::from("ChoiceU32MultField"),
            name: String::new(),
            value: None,
            default: None,
