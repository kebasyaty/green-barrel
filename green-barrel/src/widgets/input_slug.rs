...
pub struct InputSlug<'a> {
    ...
    pub slug_sources: Vec<&'a str>, // Example: vec!["title"] or vec!["hash", "username"] or vec!["email", "first_name", "last_name"].
...
impl<'a> Default for InputSlug<'a> {
    fn default() -> Self {
        Self {
            id: "",
            label: "",
