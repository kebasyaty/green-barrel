...
mod migration {
    ...
    pub fn run_migration(
        ...
        // Run fixtures
        models::TestModel::run_fixture("test", meta_store, client, validators, media_dir)?;
...
// #################################################################################################
#[test]
fn test_fixtures() -> Result<(), Box<dyn Error>> {
    ...
    let count = TestModel::estimated_document_count(&meta_store, &client, None)?;
