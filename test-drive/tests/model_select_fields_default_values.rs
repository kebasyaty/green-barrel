...
mod app_name {
    ...
    pub fn mango_migration() -> Result<(), Box<dyn std::error::Error>> {
        ...
        DB_MAP_CLIENT_NAMES.lock()?.insert(
            "TEST_default_vk_w1vCcXSvF3y5J".to_string(),
